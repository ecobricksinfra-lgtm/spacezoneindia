                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p class="text-dark">Sign in to continue to Spacezone India.</p>
                                        </div>
                                    </div>
                                    ...
                                    <a href="" class="auth-logo-light">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="assets/images/sicon.png" width="40px" alt=""  >
                                            </span>
                                        </div>
                                    </a>
...
?>
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <div>
                                ...
                                <p>© <script>document.write(new Date().getFullYear())</script> Spacezone India. Crafted with <i class="mdi mdi-heart text-danger"></i><a href ="https://hackgenix.com" target="_blank">by HackGeniX</a> </p>
                            </div>
                        </div>
