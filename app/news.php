...
if (isset($_POST['add'])) {
    ...
    {   
        ...
        $insert_query = "INSERT INTO `news`(`name`, `image`, `link`, `date`) VALUES ('$name','$image','$link','$date')";
...
?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo $row['link']; ?>" target="blanck">Link</a> 
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="deletenews.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" title="Delete"> <button type="button" class="btn btn-danger waves-effect waves-light ">
