                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Learning Videos (Age <?php echo $age; ?>)</h4>
...
if (isset($_POST['addvideo'])) {
    ...
    //Image Upload Starting
        ...
        $insert_query = "INSERT INTO `videos`(`age`, `link`, `date`, `actionby`) VALUES ('$age','$link','$date','$actionby')";
...
$select_query = "select * from videos where age='$age' order by id desc";
...
?>
                    ...
                    <iframe width="100%" height="400" src="https://www.youtube.com/embed/<?php echo $row['link']; ?>" title="Apartment balcony garden ideas || small balcony garden || latest balcony design 2025" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>    
