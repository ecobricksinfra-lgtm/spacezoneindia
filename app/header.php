<header id="page-topbar">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.php" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="assets/images/sicon.png" alt="" height="30">
                                </span>
                                <span class="logo-lg">
                                    <img src="assets/images/sicon.png" alt="" height="75">
                                </span>
                            </a>
    ...
    padding-top: 20px;
">
                                    <img  src="assets/images/sicon.png" alt="" height="40">
                                </span>
                                <span class="logo-lg">
                                    <img style="padding-top: 20px;" width="200px" src="assets/images/logo-2048x465.png" alt="" >
                                </span>
                            </a>
                        </div>
