                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Gallery - <?php echo $name; ?></h4>
                                                ...
                                                <div class="modal-dialog ">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="viewphotos.php" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="addphoto" class="btn btn-primary">Save</button>
                                                        </div>
                                                        </form>
...
if (isset($_POST['addphoto'])) {
    ...
    {   
        ...
        $insert_query = "INSERT INTO `photos`(`name`, `image`) VALUES  ('$name','$image')";
...
$select_query = "select * from photos where name = '$name' order by id asc";
...
?>
                    <div class="col-lg-2">
                                <img src="files/<?php echo $row['image']; ?>" width="100%" alt="">
                                <p style="
    text-align: center;
"><?php echo $row['image']; ?><a style="color:red;" href="deleteimage.php?name=<?php echo $row['name']; ?>&image=<?php echo $row['image']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" title="Delete">
