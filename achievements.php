            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="wow fadeInUp" data-cursor="-opaque">Our Achievements</h1>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="about-us-content" align="center">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="0.2s" data-cursor="-opaque">Milestones That Made History</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">At Space Zone India, innovation meets impact. From launching India’s first private hybrid rocket to training over 10,000+ students across India and abroad, our journey is defined by groundbreaking milestones in space education and aerospace technology. Backed by ISRO veterans and driven by passion, we continue to push boundaries and inspire the next generation of space pioneers.
                        </p>
                        </div>
                        <!-- Section Title End -->
