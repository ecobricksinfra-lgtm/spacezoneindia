            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="wow fadeInUp" data-cursor="-opaque">Photo Gallery</h1>
...
<?php $name = $_GET['name']; ?>
            <div class="section-title">
                ...
                <h2 class="wow fadeInUp" data-wow-delay="0.2s" data-cursor="-opaque"><?php echo $name; ?> Photos</h2>
...
include('app/connect.php');
        ...
        $select_query1 = "select * from photos where name = '$name' order by id desc";
...
?>  
                            <div class="col-lg-4 col-6">
                                ...
                                <div class="photo-gallery wow fadeInUp">
                                    <a href="app/files/<?php echo $row1['image']; ?>" data-cursor-text="View">
                                        <figure class="image-anime">
                                            <img src="app/files/<?php echo $row1['image']; ?>" alt="">
                                        </figure>
                                    </a>
                                </div>
                                <!-- image gallery end -->
